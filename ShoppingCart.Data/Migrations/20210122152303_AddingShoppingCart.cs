    ...
    public partial class AddingShoppingCart : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(nullable: false),
                    CartFK = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartProduct_Cart_CartFK",
                        column: x => x.CartFK,
                        principalTable: "Cart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartProduct_Products_ProductFK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartProduct_CartFK",
                table: "CartProduct",
                column: "CartFK");

            migrationBuilder.CreateIndex(
                name: "IX_CartProduct_ProductFK",
                table: "CartProduct",
                column: "ProductFK");
